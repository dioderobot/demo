...
#define PID_SPEED_KP_DEFAULT          3200/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM       3800
...
/* Phase 2 */
#define PHASE2_DURATION                400 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (400*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A           2
/* Phase 3 */
#define PHASE3_DURATION                500 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (1100*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A           3
/* Phase 4 */
#define PHASE4_DURATION                700 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (2200*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A           4
/* Phase 5 */
#define PHASE5_DURATION                1000 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (3800*SPEED_UNIT/U_RPM)
...
#define SPEED_BAND_LOWER_LIMIT         10  /*!< It expresses how much
