...
| VBUS_DET | 5 | I | 5- to 28-V $\mathrm{V}_{\text {BUS }}$ input voltage. $\mathrm{V}_{\text {BUS }}$ detection determines UFP attachment. One $\mathrm{R}_{\text {VBUS }}$ external resistor required between system $\mathrm{V}_{\text {BUS }}$ and VBUS_DET pin. |
...
| $\mathrm{V}_{\mathrm{IM}}$ | Mid-level control signal input voltage (PORT, CURRENT_MODE) |  | $0.28 \times \mathrm{V}_{\mathrm{DD}}$ |  | $0.56 \times \mathrm{V}_{\mathrm{DD}}$ | V |
| $\mathrm{V}_{\mathrm{IH}}$ | High-level control signal input voltage (PORT, CURRENT_MODE) |  | $\mathrm{V}_{\mathrm{DD}}-0.3$ |  |  | V |
...
| $\mathrm{V}_{\mathrm{OL}}$ | Low-level signal output voltage (open-drain) (VCONN_FAULT, ID, OUT1, OUT2) | $\mathrm{I}_{\mathrm{OL}}=-1.6 \mathrm{~mA}$ |  |  | 0.4 | V |
...
| $t_{\text {FAULT }}$ | VCONN_FAULT asserted low time after VCONN over-current condition is detected. (See Figure 2.) | 7 | 10 | 13 | $\mu \mathrm{s}$ |![img-3.jpeg](./images/img-3.jpeg)
...
|  TUSB321RWBRG4 | X2QFN | RWB | 12 | 3000 | 210.0 | 185.0 | 35.0  |![img-14.jpeg](./images/img-14.jpeg)
...
2. This drawing is subject to change without notice.![img-17.jpeg](./images/img-17.jpeg)

NOTES: (continued)
3. For more information, see Texas Instruments literature number SLUA271 (www.ti.com/lit/slua271).![img-18.jpeg](./images/img-18.jpeg)
