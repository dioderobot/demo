...
## Ultra-small Surface-mounting Tactile Switches with High Contact Reliability $(1.2 \times 3 \times 2.5 \mathrm{~mm}(\mathrm{H} \times \mathrm{W} \times \mathrm{D})$
...
| Ambient operating <br> temperature | $-25^{\circ} \mathrm{C}$ to $+70^{\circ} \mathrm{C}$ at $60 \%$ RH max. (with no icing or <br> condensation) |  |  |
