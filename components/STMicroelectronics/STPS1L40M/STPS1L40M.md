...
| Symbol | Parameter | Value | Unit |
| :-- | :-- | :-- | :--: |
| $\mathrm{R}_{\text {th(j-c) }}{ }^{*}$ | Junction to case | 20 | ${ }^{\circ} \mathrm{C} / \mathrm{W}$ |
| $\mathrm{R}_{\text {th(j-i) }}{ }^{*}$ | Junction to ambient | 250 | ${ }^{\circ} \mathrm{C} / \mathrm{W}$ |
...
![img-2.jpeg](./images/img-2.jpeg)Figure 3: Normalized avalanche power derating versus pulse duration
...
![img-8.jpeg](./images/img-8.jpeg)Figure 9: Junction capacitance versus reverse voltage applied (typical values)
...
![img-11.jpeg](./images/img-11.jpeg)Figure 12: STmite Package Mechanical Data
