...
$5.1 \quad \mathrm{C}_{\text {BOOT }}$ selection and charging ..... 7
...
| $\mathrm{V}_{\mathrm{cc}}$ | Supply voltage | - 0.3 to +18 | V |
...
| $\mathrm{V}_{\text {Ih }}$ | High level logic threshold <br> voltage |  | 3.6 |  |  | V |  |
| $\mathrm{I}_{\text {Ih }}$ | High level logic input current | $\mathrm{V}_{\mathrm{IN}}=15 \mathrm{~V}$ |  | 50 | 70 | mA |  |
| $\mathrm{I}_{\text {II }}$ | Low level logic input current | $\mathrm{V}_{\mathrm{IN}}=0 \mathrm{~V}$ |  |  | 1 | mA |  |

1. $R_{D S \text { (on) }}$ is tested in the following way:

$$
R_{D S O N}=\frac{\left(V_{C C}-V_{C B O O T 1}\right)-\left(V_{C C}-V_{C B O O T 2}\right)}{\mathrm{I}_{1}\left(\mathrm{~V}_{\mathrm{CC}}, \mathrm{~V}_{\mathrm{CBOOT} 1}\right)-\mathrm{I}_{2}\left(\mathrm{~V}_{\mathrm{CC}}, \mathrm{~V}_{\mathrm{CBOOT} 2}\right)}
$$

where $I_{1}$ is pin 8 current when $V_{C B O O T}=V_{C B O O T 1}, I_{2}$ when $V_{C B O O T}=V_{C B O O T 2}$
...
$$
\mathrm{C}_{\text {BOOT } \gg \gg C_{E X T}}
$$
...
![img-3.jpeg](./images/img-3.jpeg)# 6 Typical characteristic 
...
![img-8.jpeg](./images/img-8.jpeg)# Package mechanical data 
...
![img-9.jpeg](./images/img-9.jpeg)Figure 11. SO-8 mechanical data and package dimensions
...
![img-11.jpeg](./images/img-11.jpeg)# 8 Order codes 
