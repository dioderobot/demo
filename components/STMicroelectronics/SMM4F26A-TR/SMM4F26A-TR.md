...
![img-2.jpeg](./images/img-2.jpeg)Table 2. Electrical characteristics - parameter values ( $\mathrm{T}_{\text {amb }}=25^{\circ} \mathrm{C}$, unless otherwise specified)
...
1. To calculate $V_{B R}$ versus $T_{j}: V_{B R}$ at $T_{J}=V_{B R}$ at $25^{\circ} \mathrm{C} x\left(1+\sigma T \times\left(T_{j}-25\right)\right)$
2. To calculate $V_{C L}$ versus $T_{j}: V_{C L}$ at $T_{J}=V_{C L}$ at $25^{\circ} \mathrm{C} x\left(1+\sigma T \times\left(T_{j}-25\right)\right)$
3. To calculate $V_{C L \text { max }}$ versus $I_{P P_{\text {app } 0}}: V_{C L \text { max }}=V_{B R \text { max }}+R_{D} \times I_{P P_{\text {app } 0}}$
...
Figure 5. Maximum clamping voltage versus peak pulse current
...
![img-8.jpeg](./images/img-8.jpeg)Figure 9. Peak forward voltage drop versus peak forward current
...
![img-11.jpeg](./images/img-11.jpeg)# 2 Package information 
...
Figure 14. Marking layout (refer to ordering information table for marking)
...
Note: Pocket dimensions are not on scale Pocket shape may vary depending on package On bidirectional devices, marking and logo may be not always in the same direction
...
![img-18.jpeg](./images/img-18.jpeg)Figure 19. Tape and reel outline
...
![img-20.jpeg](./images/img-20.jpeg)# 3 Ordering information 
