...
![img-1.jpeg](./images/img-1.jpeg)# Contents 
...
| Soft start |  |  |  |  |  |  |
| $\mathrm{T}_{\text {SS }}$ | Soft-start duration | FSW pin floating | 7.4 | 8.2 | 9.1 | ms |
...
| $\mathrm{I}_{\text {O SOURCE }}$ | Source COMP pin | $\mathrm{V}_{\mathrm{FB}}=0.5 \mathrm{~V}, \mathrm{~V}_{\text {COMP }}=1 \mathrm{~V}$ |  | 19 |  | mA |Table 4. Electrical characteristics (continued)
...
![img-3.jpeg](./images/img-3.jpeg)# 5.1 Oscillator and synchronization 
...
![img-6.jpeg](./images/img-6.jpeg)# 5.2 Soft-start 
...
$$
D_{M I N}=\frac{V_{O U T}+V_{F}}{V_{I N M A X}-V_{S W}}
$$
...
![img-10.jpeg](./images/img-10.jpeg)In Figure 11 the Bode diagram of the PWM and LC filter transfer function [G $\mathrm{G}_{\mathrm{PW} 0} \cdot \mathrm{G}_{\mathrm{LC}}(\mathrm{f})$ ] and the open-loop gain $\left[\mathrm{G}_{\mathrm{LOOP}}(\mathrm{f}) \simeq \mathrm{G}_{\mathrm{PW} 0} \cdot \mathrm{G}_{\mathrm{LC}}(\mathrm{f}) \cdot \mathrm{G}_{\text {TYPEIII }}(\mathrm{f})\right]$ are drawn.
...
![img-12.jpeg](./images/img-12.jpeg)# 6.4.2 Type II compensation network 
...
$$In Figure 14 the Bode diagram of the PWM and LC filter transfer function [G $\mathrm{G}_{\mathrm{PW} 0} \cdot \mathrm{G}_{\mathrm{LC}}(\mathrm{f})$ ] and the open-loop gain $\left[\mathrm{G}_{\mathrm{LOOP}}(\mathrm{f})=\mathrm{G}_{\mathrm{PW} 0} \cdot \mathrm{G}_{\mathrm{LC}}(\mathrm{f}) \cdot \mathrm{G}_{\text {TYPEII }}(\mathrm{f})\right]$ are drawn.
...
![img-15.jpeg](./images/img-15.jpeg)# 6.5 Thermal considerations 
...
![img-17.jpeg](./images/img-17.jpeg)# 6.7 Application circuit 
...
![img-21.jpeg](./images/img-21.jpeg)Figure 22. Junction temperature vs. output current $V_{I N}=24 \mathrm{~V}$
...
Figure 24. Junction temperature vs. output current $V_{I N}=5 \mathrm{~V}$
...
![img-27.jpeg](./images/img-27.jpeg)![img-28.jpeg](./images/img-28.jpeg)
...
![img-32.jpeg](./images/img-32.jpeg)# 7 Application ideas 
...
$$
I_{S W}=\frac{I_{O U T}}{1-D}<3 \mathrm{~A}
$$
...
$$
I_{S W, P K}=\frac{I_{O U T}}{1-D}\left[1+\frac{r}{2}\right]<3.7 \mathrm{~A}
$$
...
![img-34.jpeg](./images/img-34.jpeg)# Equation 41 
...
![img-36.jpeg](./images/img-36.jpeg)# 8 Package information 
...
![img-37.jpeg](./images/img-37.jpeg)Table 10. VFDFPN10 ( $3 \times 3 \times 1.0 \mathrm{~mm}$ ) package mechanical data
...
![img-38.jpeg](./images/img-38.jpeg)Table 11. HSOP8 package mechanical data
