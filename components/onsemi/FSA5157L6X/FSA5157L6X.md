...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  |  |  |  | Min | Typ | Max | Min | Max |  |
| $C_{0 N}$ | Control Pin Input Capacitance | $f=1 \mathrm{MHz}$ | 0.0 |  | 1.5 |  |  |  | pF | Figure 12 |
...
Figure 9. Off Isolation# ACAO LOADINGS AND WAVEFORMS (Continued) 
