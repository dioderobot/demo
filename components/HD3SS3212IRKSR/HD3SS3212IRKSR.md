...
- Changed the $\mathrm{V}_{\mathrm{a}}$, MIN value From: 2 V To: 1.7 V in Recommended Operating Conditions ..... 5Changes from Original (May 2015) to Revision A
Page
...
| $R_{i j, C(\text { top) }}$ | Junction-to-case (top) thermal resistance | 41.8 | ${ }^{\circ} \mathrm{C} / \mathrm{W}$ |
| $R_{i j, B}$ | Junction-to-board thermal resistance | 4.4 | ${ }^{\circ} \mathrm{C} / \mathrm{W}$ |
...
| $R_{i j, C(\text { bot) }}$ | Junction-to-case (bottom) thermal resistance | 17.6 | ${ }^{\circ} \mathrm{C} / \mathrm{W}$ |
...
| $R_{\text {FLAT_ON }}$ | On-resistance flatness RON(MAX) RON(MAIN) | $\mathrm{V}_{\mathrm{CC}}=3.3 \mathrm{~V} ;-0.35 \mathrm{~V} \leq \mathrm{V}_{\mathrm{IN}} \leq 2.35 \mathrm{~V}$ |  |  | 1 | $\Omega$ |
...
Figure 11. Up Facing Port for USB3.1 USB Type-C ConnectorSystems Examples (continued)
